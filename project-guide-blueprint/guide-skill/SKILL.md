...
# Skill: Project Orchestration via GUIDE.md

## Overview
This skill provides the structure and instructions for an AI Agent to generate, maintain, and execute a `GUIDE.md` file. The `GUIDE.md` is the central source of truth for planning, tracking progress, and orchestrating work between the AI Agent and the User in a codebase during a buildout of a baseline KMP project (e.g., adding baseline KMP cababilities to a KMP template).

## Instructions for Generating a New `GUIDE.md`
When placed in a new codebase and asked to create a `GUIDE.md`, ask for details on the project requirements and generate a document following this exact structure:
