...
2. **Generate the `kmp-baseline-hints-task`:**
   Execute the instructions in `/Users/mattdyor/.skills/kmp-baseline-hints-blueprint/SKILL.md` to create the codebase-specific `.skills/kmp-baseline-hints-task/SKILL.md` file, which will act as the baseline for architecture rules and library versions. Don't forget to copy the `examples/` folder if it exists.

3. **Generate the `kmp-baseline-guide-task`:**
   Execute the instructions in `/Users/mattdyor/.skills/kmp-baseline-guide-blueprint/SKILL.md` to create the `.skills/kmp-baseline-guide-task/SKILL.md` file.
