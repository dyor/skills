...
## How to use it
- Execute the instructions for the AI Assistant below to create `.agents/skills/project-validation/SKILL.md`.
...
Read the `.agents/skills/project-guide/SKILL.md` file and identify the exact, concrete features the app will provide. Do not rely on generic development templates. Instead, ask: *What does this specific app do?* 
...
Create a file named `SKILL.md` in `.agents/skills/project-validation/`. This document must contain a rigorous, multi-layered testing plan tailored *specifically* to the app behaviors and Domain UseCases you extracted from the `project-guide`.
